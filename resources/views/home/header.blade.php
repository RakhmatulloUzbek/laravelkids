<header>
    <div class="container">
        <div class="logo">
            <a href="index.html" title="Kids Life"><img src="{{asset('assets')}}/images/logo2.png" alt="Kids Life" title="Kids Life" style="width: 200px; height: auto;"></a>
        </div>
        <div class="contact-details">
            <p class="mail">
                <a href="#"><span class="__cf_email__" data-cfemail="">contact@inspire.kids.com</span></a>
        ...
        <div class="container">
            ...
            <nav id="main-menu">
                ...
                <ul id="menu-main-menu" class="menu">
                    ...
                    <li class="mustard"> <a href="{{route('aboutus')}}"> About us </a> </li>
                    <li class="green"> <a href="{{route('ourstaffs')}}"> Our Staffs </a> </li>
                    <li class="yellow"> <a href="{{route('services')}}"> Services </a> </li>
                    <li class="blue"> <a href="{{route('portfolio')}}"> Portfolio </a> </li>
...
{{--                                                    <li>--}}
{{--                                                        <a href="#" title>--}}
{{--                                                            <img src="{{asset('assets')}}/images/product_thumb1.jpg" alt="product"> Ellents Style Grade </a>--}}
{{--                                                        <span class="amount">$20.00</span>--}}
{{--                                                    </li>--}}
{{--                                                    <li>--}}
{{--                                                        <a href="#" title>--}}
{{--                                                            <img src="{{asset('assets')}}/images/product_thumb2.jpg" alt="product"> Ellents Style Grade </a>--}}
{{--                                                        <span class="amount">$20.00</span>--}}
{{--                                                    </li>--}}
{{--                                                    <li>--}}
{{--                                                        <a href="#" title>--}}
{{--                                                            <img src="{{asset('assets')}}/images/product_thumb3.jpg" alt="product"> Ellents Style Grade </a>--}}
{{--                                                        <span class="amount">$20.00</span>--}}
{{--                                                    </li>--}}
{{--                                                </ul>--}}
{{--                                            </li>--}}
...
{{--                                                    <a href="blog-detail.html"><img src="{{asset('assets')}}/images/mega_menu_blog_img1.jpg" alt title></a>--}}
{{--                                                </div>--}}
...
{{--                                            <li class="widget widget_recent_entries">--}}
{{--                                                <div class="entry-thumb">--}}
{{--                                                    <a href="blog-detail.html"><img src="{{asset('assets')}}/images/mega_menu_blog_img2.jpg" alt title></a>--}}
{{--                                                </div>--}}
{{--                                                <div class="entry-body">--}}
...
{{--                        <a class="dt-menu-expand">+</a>--}}
{{--                    </li>--}}
{{--                    <li class="menu-item-simple-parent menu-item-depth-0 lavender"><a href="{{route('blog')}}" title>Blog</a>--}}
{{--                        <ul class="sub-menu">--}}
...
{{--                        <a class="dt-menu-expand">+</a>--}}
{{--                    </li>--}}
                    <li class="purple"><a href="{{route('blog')}}" title>Blog</a></li>
                    <li class="pink"><a href="{{route('contactus')}}" title>Contact us</a></li>
                </ul>
            </nav>
            ...
            <a href="{{route('signin')}}" class="dt-sc-button small"> Sign in <span class="fa fa-chevron-circle-right"> </span></a>
            <a href="{{route('signup')}}" class="dt-sc-button small"> Sign up <span class="fa fa-chevron-circle-right"> </span></a>
        </div>
    </div>
