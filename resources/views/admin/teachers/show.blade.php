    ...
    <div class="content-wrapper">
        ...
        <div class="col-sm-6">
            <ol class="breadrumb float-sm-right d-flex flex-row" style="list-style-type: none">
                ...
                <li class="breadcrumb-item active"><a href="{{route('admin.teachers')}}"
                                                      class="text-decoration-none">Teachers</a></li>
                    ...
                    <aside class="col-lg-4">
                        <div class="gallery-wrap">
                            <div class="img-big-wrap img-thumbnail d-block my-auto">
                                <img class="img1 img-thumbnail d-block" src="{{Storage::url($data->profile_pic)}}" alt="">
                            </div>
                        </div>
                    </aside>
                    <main class="col-lg-8">
